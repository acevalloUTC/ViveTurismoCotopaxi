...
public class HomeController extends Controller {
    ...
    public Result administrador(){
    	
    	return ok(administrador.render());
    }

    public Result atractivosingresar(){
    	...
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(atractivosingresar.render(tur,categ,sub,categ1,sub1));
    }
    ...
    //inicio 
    public Result buscarManifestaciones() 
    {
    	List<Turismo>tur=Turismo.find.all();
    	List<Canton> categ = Canton.find.all();
    	List<Parroquia> sub = Parroquia.find.all();
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(buscarManifestaciones.render(tur,categ,sub,categ1,sub1));
    	
    }
    public Result buscarNaturales() 
    {
    	List<Turismo>tur=Turismo.find.all();
    	List<Canton> categ = Canton.find.all();
    	List<Parroquia> sub = Parroquia.find.all();
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(buscarNaturales.render(tur,categ,sub,categ1,sub1));
   
    }
    public Result paramos() 
    {
    	List<Turismo>tur=Turismo.find.all();
    	List<Canton> categ = Canton.find.all();
    	List<Parroquia> sub = Parroquia.find.all();
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(paramos.render(tur,categ,sub,categ1,sub1));
  ...
  //inicio 
    public Result buscarManifestacionesVista() 
    {
    	List<Turismo>tur=Turismo.find.all();
    	List<Canton> categ = Canton.find.all();
    	List<Parroquia> sub = Parroquia.find.all();
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(buscarManifestacionesVista.render(tur,categ,sub,categ1,sub1));
    	
    }
    public Result buscarNaturalesVista() 
    {
    	List<Turismo>tur=Turismo.find.all();
    	List<Canton> categ = Canton.find.all();
    	List<Parroquia> sub = Parroquia.find.all();
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(buscarNaturalesVista.render(tur,categ,sub,categ1,sub1));
   
    }
    public Result paramosVista() 
    {
    	List<Turismo>tur=Turismo.find.all();
    	List<Canton> categ = Canton.find.all();
    	List<Parroquia> sub = Parroquia.find.all();
    	List<Categoria> categ1 = Categoria.find.all();
    	List<Subcategoria> sub1 = Subcategoria.find.all();
    	return ok(paramosVista.render(tur,categ,sub,categ1,sub1));
    ...
    public Result save(){
   	...
   	return redirect(controllers.routes.HomeController.atractivosingresar());
   }
