...
public class AdaptadorDeParamos extends BaseAdapter {
    private Context context;

    public AdaptadorDeParamos(Context context) {
        this.context = context;
    }

    @Override
    public int getCount() {
        return Paramos.ITEMS.length;
    }

    @Override
    public Paramos getItem(int position) {
        return Paramos.ITEMS[position];
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        final Paramos item = getItem(position);
